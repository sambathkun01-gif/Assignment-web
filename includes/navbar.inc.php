<nav class="navbar navbar-expand-lg">
  <div class="container">
    <a class="navbar-brand" href="<?php echo $baseUrl ?>">MOVE<span>MOVIE</span></a>
    ...
    <div class="collapse navbar-collapse" id="navMain">
      ...
      <ul class="navbar-nav align-items-center gap-1">
        <li class="nav-item">
          <a class="nav-link <?php echo (!isset($_GET['page'])||$_GET['page']==='') ? 'active':'' ?>" href="<?php echo $baseUrl ?>">Home</a>
        </li>
        <?php if($isAdmin): ?>
          <li class="nav-item">
            <a class="nav-link <?php echo (isset($_GET['page'])&&strpos($_GET['page'],'admin')===0)?'active':'' ?>" href="<?php echo $baseUrl ?>?page=admin/dashboard">Admin</a>
          </li>
        <?php endif; ?>
        <?php if($user): ?>
          <li class="nav-item">
            <a class="nav-link <?php echo (isset($_GET['page'])&&$_GET['page']==='dashboard')?'active':'' ?>" href="<?php echo $baseUrl ?>?page=dashboard">Dashboard</a>
          </li>
        ...
        <?php else: ?>
          <li class="nav-item"><a class="nav-link" href="<?php echo $baseUrl ?>?page=login">Login</a></li>
